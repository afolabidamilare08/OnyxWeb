...
import ImgMobile from '../assets/images/well.jpg'

const SectionX = () => {
  return (
    <div className="md:px-8 lg:px-16 relative hidden md:flex justify-between items-center h-max bg-cover bg-center bg-no-repeat" style={{
